...
function addCmdToTable(_cmd) {
    ...
    tr += '<td><input class="cmdAttr form-control input-sm" data-l1key="configuration" data-l2key="username"></td>';
    tr += '<td><input class="cmdAttr form-control input-sm" data-l1key="configuration" data-l2key="password"></td>';
    tr += '<td>';
